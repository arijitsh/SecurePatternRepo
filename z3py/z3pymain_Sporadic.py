...
def FindMinimumAttackLem(modelName, pattern, sporadicity):
    ...
    print("Finding minimum attack length for "+str(modelName)+" and pattern "+str(pattern)+" with sporadic security of period "+str(sporadicity))
    ...
    while isSat == 0:  
        ...
        while (index<patternLen) and (isSat == 0):
            ...
            print(dropPattern)
            print("\n")
            fileName = modelName + "_sporadic_" + str(th) + "_" +str(index)+"_"+str(attackLen)+"_"+str(K)+"_"+str(pattern)+"_"+str(sporadicity)+".py"
            ...
            for i in range(K):
                ...
                if dropPattern[i]: #If there is a 1 in the pattern
                    ...
                    for varcount1 in range(1,u_count+1):
                        ...
                        expr_u+=")\n"
                    f.write(expr_u)
                    if (i == (j+index)) and (i%sporadicity!=0):      # If in this iteration we can give an attack      
                        expr_uatk=""
                        for varcount1 in range(1,u_count+1):
                ...
                # Update y
                if (i == (j+index)) and (i%sporadicity!=0):
                    expr_y=""
                    for varcount1 in range(1,y_count+1):
