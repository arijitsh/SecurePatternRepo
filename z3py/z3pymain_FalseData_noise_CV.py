    ...
    for count in range(len(attackPoints)):
        ...
        while attackLen<=counter and isSat == 0:
            ...
            while (index + attackLen)<=end and (isSat == 0):
                ...
                fileName1 = dt + "_FalseData_noise_" +str(start)+ "_"+str(attackLen)+"_WithRange"+str(attackRange)
                ...
                for i in range(counter):
                    ...
                    if i == (j+index - start):      # If in this iteration we can give an attack      
                        ...
                        expr_uatk+="s.add(uattacked1_"+str(i+1)+" == attackOnU_"+str(i)+")\n"
                        f.write(expr_uatk)
                    ...
                    # bound on acceleration after attack
                    f.write("s.add(And(uattacked3_"+str(i+1)+"<="+str(accRange)+",uattacked3_"+str(i+1)+">=-"+str(accRange)+"))\n")       
