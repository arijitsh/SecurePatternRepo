...
xabs1 = np.zeros(18, dtype=float)
x1 = np.zeros(18, dtype=float)
z1 = np.zeros(18, dtype=float)
xabs2 = np.zeros(18, dtype=float)
x2 = np.zeros(18, dtype=float)
z2 = np.zeros(18, dtype=float)
y1 = np.zeros(18, dtype=float)
attackOnY1 = np.zeros(18, dtype=float)
r1 = np.zeros(18, dtype=float)
u1 = np.zeros(18, dtype=float)
uattacked1 = np.zeros(18, dtype=float)
attackOnU1 = np.zeros(18, dtype=float)
...
s.add(y1_13 == (1.0*attackOnY1_12) + (0*x1_13) + (1*x2_13) + (0*uattacked1_13))
# pattern = 1
...
s.add(u1_16 ==  - (-0.0987*z1_16) - (0.142*z2_16))
...
s.add(r_16 ==rabs1_16 )
s.add(r_16<0.003)
s.add(z1_17 ==  (0.445*z1_16) + (-0.0458*z2_16) + (0.055*u1_16) + (-0.039*r1_16) )
s.add(z2_17 ==  (1.2939*z1_16) + (0.4402*z2_16) + (4.5607*u1_16) + (0.4339*r1_16) )
s.add(x1_17 ==  (0.445*x1_16) + (-0.0458*x2_16) + (0.055*uattacked1_16) )
s.add(x2_17 ==  (1.2939*x1_16) + (0.4402*x2_16) + (4.5607*uattacked1_16) )
s.add(xabs1_17 == If(x1_17<0,(-1)*x1_17,x1_17))
s.add(xabs2_17 == If(x2_17<0,(-1)*x2_17,x2_17))
s.add(u1_17 == u1_16)
s.add(uattacked1_17 == uattacked1_16)
s.add(y1_17 ==  + (0*x1_17) + (1*x2_17) + (0*uattacked1_17))
s.add(Or((xabs1_0 - 1)>0.1,(xabs1_1 - 1)>0.1,(xabs1_2 - 1)>0.1,(xabs1_3 - 1)>0.1,(xabs1_4 - 1)>0.1,(xabs1_5 - 1)>0.1,(xabs1_6 - 1)>0.1,(xabs1_7 - 1)>0.1,(xabs1_8 - 1)>0.1,(xabs1_9 - 1)>0.1,(xabs1_10 - 1)>0.1,(xabs1_11 - 1)>0.1,(xabs1_12 - 1)>0.1,(xabs1_13 - 1)>0.1,(xabs1_14 - 1)>0.1,(xabs1_15 - 1)>0.1,(xabs1_16 - 1)>0.1,(xabs2_0 - 2)>0.1,(xabs2_1 - 2)>0.1,(xabs2_2 - 2)>0.1,(xabs2_3 - 2)>0.1,(xabs2_4 - 2)>0.1,(xabs2_5 - 2)>0.1,(xabs2_6 - 2)>0.1,(xabs2_7 - 2)>0.1,(xabs2_8 - 2)>0.1,(xabs2_9 - 2)>0.1,(xabs2_10 - 2)>0.1,(xabs2_11 - 2)>0.1,(xabs2_12 - 2)>0.1,(xabs2_13 - 2)>0.1,(xabs2_14 - 2)>0.1,(xabs2_15 - 2)>0.1,(xabs2_16 - 2)>0.1))
