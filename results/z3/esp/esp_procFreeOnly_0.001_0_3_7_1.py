...
s.add(x1_1 ==  (0.7471*x1_0) + (-0.0286*x2_0) + (0.0795*uattacked1_0) )
s.add(x2_1 ==  (0.8081*x1_0) + (0.7441*x2_0) + (2.189*uattacked1_0) )
...
s.add(x1_2 ==  (0.7471*x1_1) + (-0.0286*x2_1) + (0.0795*uattacked1_1) )
s.add(x2_2 ==  (0.8081*x1_1) + (0.7441*x2_1) + (2.189*uattacked1_1) )
...
s.add(x1_3 ==  (0.7471*x1_2) + (-0.0286*x2_2) + (0.0795*uattacked1_2) )
s.add(x2_3 ==  (0.8081*x1_2) + (0.7441*x2_2) + (2.189*uattacked1_2) )
...
s.add(x1_4 ==  (0.7471*x1_3) + (-0.0286*x2_3) + (0.0795*uattacked1_3) )
s.add(x2_4 ==  (0.8081*x1_3) + (0.7441*x2_3) + (2.189*uattacked1_3) )
...
s.add(x1_5 ==  (0.7471*x1_4) + (-0.0286*x2_4) + (0.0795*uattacked1_4) )
s.add(x2_5 ==  (0.8081*x1_4) + (0.7441*x2_4) + (2.189*uattacked1_4) )
...
s.add(x1_6 ==  (0.7471*x1_5) + (-0.0286*x2_5) + (0.0795*uattacked1_5) )
s.add(x2_6 ==  (0.8081*x1_5) + (0.7441*x2_5) + (2.189*uattacked1_5) )
...
s.add(x1_7 ==  (0.7471*x1_6) + (-0.0286*x2_6) + (0.0795*uattacked1_6) )
s.add(x2_7 ==  (0.8081*x1_6) + (0.7441*x2_6) + (2.189*uattacked1_6) )
...
s.add(Or((xabs1_0 - 1)>0.1,(xabs1_1 - 1)>0.1,(xabs1_2 - 1)>0.1,(xabs1_3 - 1)>0.1,(xabs1_4 - 1)>0.1,(xabs1_5 - 1)>0.1,(xabs1_6 - 1)>0.1,(xabs2_0 - 2)>0.1,(xabs2_1 - 2)>0.1,(xabs2_2 - 2)>0.1,(xabs2_3 - 2)>0.1,(xabs2_4 - 2)>0.1,(xabs2_5 - 2)>0.1,(xabs2_6 - 2)>0.1))
