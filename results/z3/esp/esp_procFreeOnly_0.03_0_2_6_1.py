...
xabs1 = np.zeros(7, dtype=float)
x1 = np.zeros(7, dtype=float)
z1 = np.zeros(7, dtype=float)
xabs2 = np.zeros(7, dtype=float)
...
uattacked1 = np.zeros(7, dtype=float)
...
s.add(Or((xabs1_0 - 1)>0.1,(xabs1_1 - 1)>0.1,(xabs1_2 - 1)>0.1,(xabs1_3 - 1)>0.1,(xabs1_4 - 1)>0.1,(xabs1_5 - 1)>0.1,(xabs2_0 - 2)>0.1,(xabs2_1 - 2)>0.1,(xabs2_2 - 2)>0.1,(xabs2_3 - 2)>0.1,(xabs2_4 - 2)>0.1,(xabs2_5 - 2)>0.1))
