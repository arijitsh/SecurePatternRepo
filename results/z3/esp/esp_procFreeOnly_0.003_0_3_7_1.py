...
s.add(x1_0 >= -0.020000000000000004)
s.add(x1_0 <= 0.020000000000000004)
s.add(z1_0 == 0)
s.add(xabs1_0 == If(x1_0<0,(-1)*x1_0,x1_0))
s.add(x2_0 >= -0.04000000000000001)
s.add(x2_0 <= 0.04000000000000001)
s.add(z2_0 == 0)
...
s.add(Or((xabs1_0 - 0.2)>0.01,(xabs1_1 - 0.2)>0.01,(xabs1_2 - 0.2)>0.01,(xabs1_3 - 0.2)>0.01,(xabs1_4 - 0.2)>0.01,(xabs1_5 - 0.2)>0.01,(xabs1_6 - 0.2)>0.01,(xabs2_0 - 0.4)>0.01,(xabs2_1 - 0.4)>0.01,(xabs2_2 - 0.4)>0.01,(xabs2_3 - 0.4)>0.01,(xabs2_4 - 0.4)>0.01,(xabs2_5 - 0.4)>0.01,(xabs2_6 - 0.4)>0.01))
