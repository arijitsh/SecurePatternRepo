...
s.add(uattacked1_0 == u1_0+ (1.0*attackOnU1_0))
attackOnY1_0 = Real('attackOnY1_0')
attackOnY2_0 = Real('attackOnY2_0')
s.add(y1_0 == (1.0*attackOnY1_0) + (1*x1_0) + (0*x2_0) + (0*u1_0))
s.add(y2_0 == (0.0*attackOnY2_0) + (0*x1_0) + (1*x2_0) + (0*u1_0))
s.add(r1_0 == y1_0 - (1*z1_0) - (0*z2_0) - (0*uattacked1_0))
s.add(r2_0 == y2_0 - (0*z1_0) - (1*z2_0) - (0*uattacked1_0))
...
s.add(Or((xabs1_0 - 0.1)>0.001,(xabs1_1 - 0.1)>0.001,(xabs1_2 - 0.1)>0.001,(xabs1_3 - 0.1)>0.001,(xabs1_4 - 0.1)>0.001,(xabs1_5 - 0.1)>0.001,(xabs1_6 - 0.1)>0.001,(xabs1_7 - 0.1)>0.001,(xabs1_8 - 0.1)>0.001,(xabs2_0 - 0.05)>0.0001,(xabs2_1 - 0.05)>0.0001,(xabs2_2 - 0.05)>0.0001,(xabs2_3 - 0.05)>0.0001,(xabs2_4 - 0.05)>0.0001,(xabs2_5 - 0.05)>0.0001,(xabs2_6 - 0.05)>0.0001,(xabs2_7 - 0.05)>0.0001,(xabs2_8 - 0.05)>0.0001))
