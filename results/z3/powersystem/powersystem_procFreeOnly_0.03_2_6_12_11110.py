...
y2 = np.zeros(13, dtype=float)
attackOnY2 = np.zeros(13, dtype=float)
r2 = np.zeros(13, dtype=float)
...
s.add(Or((xabs1_0 - 0.1)>0.001,(xabs1_1 - 0.1)>0.001,(xabs1_2 - 0.1)>0.001,(xabs1_3 - 0.1)>0.001,(xabs1_4 - 0.1)>0.001,(xabs1_5 - 0.1)>0.001,(xabs1_6 - 0.1)>0.001,(xabs1_7 - 0.1)>0.001,(xabs1_8 - 0.1)>0.001,(xabs1_9 - 0.1)>0.001,(xabs1_10 - 0.1)>0.001,(xabs1_11 - 0.1)>0.001,(xabs2_0 - 0.05)>0.0001,(xabs2_1 - 0.05)>0.0001,(xabs2_2 - 0.05)>0.0001,(xabs2_3 - 0.05)>0.0001,(xabs2_4 - 0.05)>0.0001,(xabs2_5 - 0.05)>0.0001,(xabs2_6 - 0.05)>0.0001,(xabs2_7 - 0.05)>0.0001,(xabs2_8 - 0.05)>0.0001,(xabs2_9 - 0.05)>0.0001,(xabs2_10 - 0.05)>0.0001,(xabs2_11 - 0.05)>0.0001))
