...
s.add(y2_7 == (0.0*attackOnY2_7) + (0*x1_7) + (1*x2_7) + (0*u1_7))
...
s.add(r2_11 == y2_11 - (0*z1_11) - (1*z2_11) - (0*uattacked1_11))
s.add(rabs1_11 == If(r1_11<0,(-1)*r1_11,r1_11))
s.add(rabs2_11 == If(r2_11<0,(-1)*r2_11,r2_11))
s.add(r_11 ==rabs1_11 +rabs2_11 )
s.add(r_11<0.03)
s.add(Or(xabs1_0>0.1,xabs1_1>0.1,xabs1_2>0.1,xabs1_3>0.1,xabs1_4>0.1,xabs1_5>0.1,xabs1_6>0.1,xabs1_7>0.1,xabs1_8>0.1,xabs1_9>0.1,xabs1_10>0.1,xabs2_0>0.05,xabs2_1>0.05,xabs2_2>0.05,xabs2_3>0.05,xabs2_4>0.05,xabs2_5>0.05,xabs2_6>0.05,xabs2_7>0.05,xabs2_8>0.05,xabs2_9>0.05,xabs2_10>0.05))
