...
xabs1 = np.zeros(36, dtype=float)
x1 = np.zeros(36, dtype=float)
z1 = np.zeros(36, dtype=float)
xabs2 = np.zeros(36, dtype=float)
x2 = np.zeros(36, dtype=float)
z2 = np.zeros(36, dtype=float)
y1 = np.zeros(36, dtype=float)
attackOnY1 = np.zeros(36, dtype=float)
r1 = np.zeros(36, dtype=float)
y2 = np.zeros(36, dtype=float)
attackOnY2 = np.zeros(36, dtype=float)
r2 = np.zeros(36, dtype=float)
u1 = np.zeros(36, dtype=float)
uattacked1 = np.zeros(36, dtype=float)
attackOnU1 = np.zeros(36, dtype=float)
r = np.zeros(36, dtype=float)
...
s.add(r2_32 == y2_32 - (0*z1_32) - (1*z2_32) - (0*u1_32))
s.add(rabs1_32 == If(r1_32<0,(-1)*r1_32,r1_32))
s.add(rabs2_32 == If(r2_32<0,(-1)*r2_32,r2_32))
s.add(r_32 ==rabs1_32 +rabs2_32 )
s.add(r_32<0.03)
s.add(z1_33 ==  (0.66*z1_32) + (0.53*z2_32) + (0.34*u1_32) + (0.36*r1_32) + (0.27*r2_32) )
s.add(z2_33 ==  (-0.53*z1_32) + (0.13*z2_32) + (0.53*u1_32) + (-0.31*r1_32) + (0.08*r2_32) )
s.add(x1_33 ==  (0.66*x1_32) + (0.53*x2_32) + (0.34*uattacked1_32) )
s.add(x2_33 ==  (-0.53*x1_32) + (0.13*x2_32) + (0.53*uattacked1_32) )
s.add(xabs1_33 == If(x1_33<0,(-1)*x1_33,x1_33))
s.add(xabs2_33 == If(x2_33<0,(-1)*x2_33,x2_33))
s.add(u1_33 ==  - (0.0556*z1_33) - (0.3306*z2_33))
s.add(uattacked1_33 == u1_33)
s.add(y1_33 ==  + (1*x1_33) + (0*x2_33) + (0*uattacked1_33))
s.add(y2_33 ==  + (0*x1_33) + (1*x2_33) + (0*uattacked1_33))
# pattern = 1
s.add(r1_33 == y1_33 - (1*z1_33) - (0*z2_33) - (0*u1_33))
s.add(r2_33 == y2_33 - (0*z1_33) - (1*z2_33) - (0*u1_33))
s.add(rabs1_33 == If(r1_33<0,(-1)*r1_33,r1_33))
s.add(rabs2_33 == If(r2_33<0,(-1)*r2_33,r2_33))
s.add(r_33 ==rabs1_33 +rabs2_33 )
s.add(r_33<0.03)
s.add(z1_34 ==  (0.66*z1_33) + (0.53*z2_33) + (0.34*u1_33) + (0.36*r1_33) + (0.27*r2_33) )
s.add(z2_34 ==  (-0.53*z1_33) + (0.13*z2_33) + (0.53*u1_33) + (-0.31*r1_33) + (0.08*r2_33) )
s.add(x1_34 ==  (0.66*x1_33) + (0.53*x2_33) + (0.34*uattacked1_33) )
s.add(x2_34 ==  (-0.53*x1_33) + (0.13*x2_33) + (0.53*uattacked1_33) )
s.add(xabs1_34 == If(x1_34<0,(-1)*x1_34,x1_34))
s.add(xabs2_34 == If(x2_34<0,(-1)*x2_34,x2_34))
s.add(u1_34 ==  - (0.0556*z1_34) - (0.3306*z2_34))
s.add(uattacked1_34 == u1_34)
s.add(y1_34 ==  + (1*x1_34) + (0*x2_34) + (0*uattacked1_34))
s.add(y2_34 ==  + (0*x1_34) + (1*x2_34) + (0*uattacked1_34))
# pattern = 1
s.add(r1_34 == y1_34 - (1*z1_34) - (0*z2_34) - (0*u1_34))
s.add(r2_34 == y2_34 - (0*z1_34) - (1*z2_34) - (0*u1_34))
s.add(rabs1_34 == If(r1_34<0,(-1)*r1_34,r1_34))
s.add(rabs2_34 == If(r2_34<0,(-1)*r2_34,r2_34))
s.add(r_34 ==rabs1_34 +rabs2_34 )
s.add(r_34<0.03)
s.add(z1_35 ==  (0.66*z1_34) + (0.53*z2_34) + (0.34*u1_34) + (0.36*r1_34) + (0.27*r2_34) )
s.add(z2_35 ==  (-0.53*z1_34) + (0.13*z2_34) + (0.53*u1_34) + (-0.31*r1_34) + (0.08*r2_34) )
s.add(x1_35 ==  (0.66*x1_34) + (0.53*x2_34) + (0.34*uattacked1_34) )
s.add(x2_35 ==  (-0.53*x1_34) + (0.13*x2_34) + (0.53*uattacked1_34) )
s.add(xabs1_35 == If(x1_35<0,(-1)*x1_35,x1_35))
s.add(xabs2_35 == If(x2_35<0,(-1)*x2_35,x2_35))
s.add(u1_35 ==  - (0.0556*z1_35) - (0.3306*z2_35))
s.add(uattacked1_35 == u1_35)
s.add(y1_35 ==  + (1*x1_35) + (0*x2_35) + (0*uattacked1_35))
s.add(y2_35 ==  + (0*x1_35) + (1*x2_35) + (0*uattacked1_35))
s.add(Or((xabs1_0 - 0.1)>0.001,(xabs1_1 - 0.1)>0.001,(xabs1_2 - 0.1)>0.001,(xabs1_3 - 0.1)>0.001,(xabs1_4 - 0.1)>0.001,(xabs1_5 - 0.1)>0.001,(xabs1_6 - 0.1)>0.001,(xabs1_7 - 0.1)>0.001,(xabs1_8 - 0.1)>0.001,(xabs1_9 - 0.1)>0.001,(xabs1_10 - 0.1)>0.001,(xabs1_11 - 0.1)>0.001,(xabs1_12 - 0.1)>0.001,(xabs1_13 - 0.1)>0.001,(xabs1_14 - 0.1)>0.001,(xabs1_15 - 0.1)>0.001,(xabs1_16 - 0.1)>0.001,(xabs1_17 - 0.1)>0.001,(xabs1_18 - 0.1)>0.001,(xabs1_19 - 0.1)>0.001,(xabs1_20 - 0.1)>0.001,(xabs1_21 - 0.1)>0.001,(xabs1_22 - 0.1)>0.001,(xabs1_23 - 0.1)>0.001,(xabs1_24 - 0.1)>0.001,(xabs1_25 - 0.1)>0.001,(xabs1_26 - 0.1)>0.001,(xabs1_27 - 0.1)>0.001,(xabs1_28 - 0.1)>0.001,(xabs1_29 - 0.1)>0.001,(xabs1_30 - 0.1)>0.001,(xabs1_31 - 0.1)>0.001,(xabs1_32 - 0.1)>0.001,(xabs1_33 - 0.1)>0.001,(xabs1_34 - 0.1)>0.001,(xabs2_0 - 0.05)>0.0001,(xabs2_1 - 0.05)>0.0001,(xabs2_2 - 0.05)>0.0001,(xabs2_3 - 0.05)>0.0001,(xabs2_4 - 0.05)>0.0001,(xabs2_5 - 0.05)>0.0001,(xabs2_6 - 0.05)>0.0001,(xabs2_7 - 0.05)>0.0001,(xabs2_8 - 0.05)>0.0001,(xabs2_9 - 0.05)>0.0001,(xabs2_10 - 0.05)>0.0001,(xabs2_11 - 0.05)>0.0001,(xabs2_12 - 0.05)>0.0001,(xabs2_13 - 0.05)>0.0001,(xabs2_14 - 0.05)>0.0001,(xabs2_15 - 0.05)>0.0001,(xabs2_16 - 0.05)>0.0001,(xabs2_17 - 0.05)>0.0001,(xabs2_18 - 0.05)>0.0001,(xabs2_19 - 0.05)>0.0001,(xabs2_20 - 0.05)>0.0001,(xabs2_21 - 0.05)>0.0001,(xabs2_22 - 0.05)>0.0001,(xabs2_23 - 0.05)>0.0001,(xabs2_24 - 0.05)>0.0001,(xabs2_25 - 0.05)>0.0001,(xabs2_26 - 0.05)>0.0001,(xabs2_27 - 0.05)>0.0001,(xabs2_28 - 0.05)>0.0001,(xabs2_29 - 0.05)>0.0001,(xabs2_30 - 0.05)>0.0001,(xabs2_31 - 0.05)>0.0001,(xabs2_32 - 0.05)>0.0001,(xabs2_33 - 0.05)>0.0001,(xabs2_34 - 0.05)>0.0001))
