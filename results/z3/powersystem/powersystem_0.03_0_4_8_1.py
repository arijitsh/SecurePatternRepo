...
y2 = np.zeros(9, dtype=float)
attackOnY2 = np.zeros(9, dtype=float)
r2 = np.zeros(9, dtype=float)
...
s.add(u1_1 ==  - (0.0556*z1_0) - (0.3306*z2_0))
...
s.add(y1_1 == (1.0*attackOnY1_0) + (1*x1_1) + (0*x2_1) + (0*u1_1))
s.add(y2_1 == (0.0*attackOnY2_0) + (0*x1_1) + (1*x2_1) + (0*u1_1))
# pattern = 1
...
s.add(u1_2 ==  - (0.0556*z1_1) - (0.3306*z2_1))
...
s.add(y1_2 == (1.0*attackOnY1_1) + (1*x1_2) + (0*x2_2) + (0*u1_2))
s.add(y2_2 == (0.0*attackOnY2_1) + (0*x1_2) + (1*x2_2) + (0*u1_2))
# pattern = 1
...
s.add(u1_3 ==  - (0.0556*z1_2) - (0.3306*z2_2))
...
s.add(y1_3 == (1.0*attackOnY1_2) + (1*x1_3) + (0*x2_3) + (0*u1_3))
s.add(y2_3 == (0.0*attackOnY2_2) + (0*x1_3) + (1*x2_3) + (0*u1_3))
# pattern = 1
...
s.add(u1_4 ==  - (0.0556*z1_3) - (0.3306*z2_3))
...
s.add(y1_4 == (1.0*attackOnY1_3) + (1*x1_4) + (0*x2_4) + (0*u1_4))
s.add(y2_4 == (0.0*attackOnY2_3) + (0*x1_4) + (1*x2_4) + (0*u1_4))
# pattern = 1
...
s.add(u1_5 ==  - (0.0556*z1_4) - (0.3306*z2_4))
...
s.add(u1_6 ==  - (0.0556*z1_5) - (0.3306*z2_5))
...
s.add(u1_7 ==  - (0.0556*z1_6) - (0.3306*z2_6))
...
s.add(u1_8 ==  - (0.0556*z1_7) - (0.3306*z2_7))
s.add(uattacked1_8 == u1_8)
s.add(y1_8 ==  + (1*x1_8) + (0*x2_8) + (0*u1_8))
s.add(y2_8 ==  + (0*x1_8) + (1*x2_8) + (0*u1_8))
s.add(Or((xabs1_0 - 0.1)>0.001,(xabs1_1 - 0.1)>0.001,(xabs1_2 - 0.1)>0.001,(xabs1_3 - 0.1)>0.001,(xabs1_4 - 0.1)>0.001,(xabs1_5 - 0.1)>0.001,(xabs1_6 - 0.1)>0.001,(xabs1_7 - 0.1)>0.001,(xabs2_0 - 0.05)>0.0001,(xabs2_1 - 0.05)>0.0001,(xabs2_2 - 0.05)>0.0001,(xabs2_3 - 0.05)>0.0001,(xabs2_4 - 0.05)>0.0001,(xabs2_5 - 0.05)>0.0001,(xabs2_6 - 0.05)>0.0001,(xabs2_7 - 0.05)>0.0001))
