...
y2 = np.zeros(12, dtype=float)
attackOnY2 = np.zeros(12, dtype=float)
r2 = np.zeros(12, dtype=float)
...
s.add(y2_5 == (0.0*attackOnY2_4) + (0*x1_5) + (1*x2_5) + (0*u1_5))
# pattern = 0
...
s.add(y2_7 == (0.0*attackOnY2_6) + (0*x1_7) + (1*x2_7) + (0*u1_7))
# pattern = 0
...
s.add(u1_9 ==  - (0.0556*z1_8) - (0.3306*z2_8))
...
s.add(Or((xabs1_0 - 0.1)>0.001,(xabs1_1 - 0.1)>0.001,(xabs1_2 - 0.1)>0.001,(xabs1_3 - 0.1)>0.001,(xabs1_4 - 0.1)>0.001,(xabs1_5 - 0.1)>0.001,(xabs1_6 - 0.1)>0.001,(xabs1_7 - 0.1)>0.001,(xabs1_8 - 0.1)>0.001,(xabs1_9 - 0.1)>0.001,(xabs1_10 - 0.1)>0.001,(xabs2_0 - 0.05)>0.0001,(xabs2_1 - 0.05)>0.0001,(xabs2_2 - 0.05)>0.0001,(xabs2_3 - 0.05)>0.0001,(xabs2_4 - 0.05)>0.0001,(xabs2_5 - 0.05)>0.0001,(xabs2_6 - 0.05)>0.0001,(xabs2_7 - 0.05)>0.0001,(xabs2_8 - 0.05)>0.0001,(xabs2_9 - 0.05)>0.0001,(xabs2_10 - 0.05)>0.0001))
