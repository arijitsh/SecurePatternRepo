...
y2 = np.zeros(18, dtype=float)
attackOnY2 = np.zeros(18, dtype=float)
r2 = np.zeros(18, dtype=float)
...
s.add(y2_5 == (0.0*attackOnY2_4) + (0*x1_5) + (1*x2_5) + (0*uattacked1_5))
# pattern = 1
...
s.add(y2_6 == (0.0*attackOnY2_5) + (0*x1_6) + (1*x2_6) + (0*uattacked1_6))
# pattern = 0
...
s.add(y2_7 == (0.0*attackOnY2_6) + (0*x1_7) + (1*x2_7) + (0*uattacked1_7))
# pattern = 0
...
attackOnY2_7 = Real('attackOnY2_7')
s.add(y1_8 == (1.0*attackOnY1_7) + (1*x1_8) + (0*x2_8) + (0*uattacked1_8))
s.add(y2_8 == (0.0*attackOnY2_7) + (0*x1_8) + (1*x2_8) + (0*uattacked1_8))
# pattern = 0
...
attackOnY2_8 = Real('attackOnY2_8')
s.add(y1_9 == (1.0*attackOnY1_8) + (1*x1_9) + (0*x2_9) + (0*uattacked1_9))
s.add(y2_9 == (0.0*attackOnY2_8) + (0*x1_9) + (1*x2_9) + (0*uattacked1_9))
# pattern = 0
...
attackOnY2_9 = Real('attackOnY2_9')
s.add(y1_10 == (1.0*attackOnY1_9) + (1*x1_10) + (0*x2_10) + (0*uattacked1_10))
s.add(y2_10 == (0.0*attackOnY2_9) + (0*x1_10) + (1*x2_10) + (0*uattacked1_10))
# pattern = 1
...
attackOnY2_11 = Real('attackOnY2_11')
s.add(y1_12 == (1.0*attackOnY1_11) + (1*x1_12) + (0*x2_12) + (0*uattacked1_12))
s.add(y2_12 == (0.0*attackOnY2_11) + (0*x1_12) + (1*x2_12) + (0*uattacked1_12))
# pattern = 0
...
attackOnY2_12 = Real('attackOnY2_12')
s.add(y1_13 == (1.0*attackOnY1_12) + (1*x1_13) + (0*x2_13) + (0*uattacked1_13))
s.add(y2_13 == (0.0*attackOnY2_12) + (0*x1_13) + (1*x2_13) + (0*uattacked1_13))
# pattern = 0
...
s.add(u1_16 ==  - (0.0556*z1_15) - (0.3306*z2_15))
...
s.add(Or((xabs1_0 - 0.1)>0.001,(xabs1_1 - 0.1)>0.001,(xabs1_2 - 0.1)>0.001,(xabs1_3 - 0.1)>0.001,(xabs1_4 - 0.1)>0.001,(xabs1_5 - 0.1)>0.001,(xabs1_6 - 0.1)>0.001,(xabs1_7 - 0.1)>0.001,(xabs1_8 - 0.1)>0.001,(xabs1_9 - 0.1)>0.001,(xabs1_10 - 0.1)>0.001,(xabs1_11 - 0.1)>0.001,(xabs1_12 - 0.1)>0.001,(xabs1_13 - 0.1)>0.001,(xabs1_14 - 0.1)>0.001,(xabs1_15 - 0.1)>0.001,(xabs1_16 - 0.1)>0.001,(xabs2_0 - 0.05)>0.0001,(xabs2_1 - 0.05)>0.0001,(xabs2_2 - 0.05)>0.0001,(xabs2_3 - 0.05)>0.0001,(xabs2_4 - 0.05)>0.0001,(xabs2_5 - 0.05)>0.0001,(xabs2_6 - 0.05)>0.0001,(xabs2_7 - 0.05)>0.0001,(xabs2_8 - 0.05)>0.0001,(xabs2_9 - 0.05)>0.0001,(xabs2_10 - 0.05)>0.0001,(xabs2_11 - 0.05)>0.0001,(xabs2_12 - 0.05)>0.0001,(xabs2_13 - 0.05)>0.0001,(xabs2_14 - 0.05)>0.0001,(xabs2_15 - 0.05)>0.0001,(xabs2_16 - 0.05)>0.0001))
