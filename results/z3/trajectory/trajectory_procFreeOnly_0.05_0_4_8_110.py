...
xabs1 = np.zeros(9, dtype=float)
x1 = np.zeros(9, dtype=float)
z1 = np.zeros(9, dtype=float)
xabs2 = np.zeros(9, dtype=float)
x2 = np.zeros(9, dtype=float)
z2 = np.zeros(9, dtype=float)
y1 = np.zeros(9, dtype=float)
attackOnY1 = np.zeros(9, dtype=float)
r1 = np.zeros(9, dtype=float)
u1 = np.zeros(9, dtype=float)
uattacked1 = np.zeros(9, dtype=float)
attackOnU1 = np.zeros(9, dtype=float)
...
s.add(Or((xabs1_0 - 1)>0.1,(xabs1_1 - 1)>0.1,(xabs1_2 - 1)>0.1,(xabs1_3 - 1)>0.1,(xabs1_4 - 1)>0.1,(xabs1_5 - 1)>0.1,(xabs1_6 - 1)>0.1,(xabs1_7 - 1)>0.1,(xabs2_0 - 10)>0.1,(xabs2_1 - 10)>0.1,(xabs2_2 - 10)>0.1,(xabs2_3 - 10)>0.1,(xabs2_4 - 10)>0.1,(xabs2_5 - 10)>0.1,(xabs2_6 - 10)>0.1,(xabs2_7 - 10)>0.1))
