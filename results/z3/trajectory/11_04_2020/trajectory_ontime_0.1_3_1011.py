...
s.add(x1_2 ==  (1.0*x1_1) + (0.1*x2_1) + (0.005*u1_1) )
s.add(x2_2 ==  (0.0*x1_1) + (1.0*x2_1) + (0.1*u1_1) )
...
s.add(x1_3 ==  (1.0*x1_2) + (0.1*x2_2) + (0.005*u1_2) )
s.add(x2_3 ==  (0.0*x1_2) + (1.0*x2_2) + (0.1*u1_2) )
...
s.add(Or((xabs1_3>0.1),(xabs2_3>1.0)))
