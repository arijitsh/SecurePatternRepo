...
xabs1 = np.zeros(10, dtype=float)
x1 = np.zeros(10, dtype=float)
z1 = np.zeros(10, dtype=float)
xabs2 = np.zeros(10, dtype=float)
...
uattacked1 = np.zeros(10, dtype=float)
...
s.add(x1_1 ==  (1.0*x1_0) + (0.2*x2_0) + (0.02*uattacked1_0) )
s.add(x2_1 ==  (0.0*x1_0) + (1.0*x2_0) + (0.2*uattacked1_0) )
...
s.add(x1_2 ==  (1.0*x1_1) + (0.2*x2_1) + (0.02*uattacked1_1) )
s.add(x2_2 ==  (0.0*x1_1) + (1.0*x2_1) + (0.2*uattacked1_1) )
...
s.add(x1_3 ==  (1.0*x1_2) + (0.2*x2_2) + (0.02*uattacked1_2) )
s.add(x2_3 ==  (0.0*x1_2) + (1.0*x2_2) + (0.2*uattacked1_2) )
...
s.add(x1_4 ==  (1.0*x1_3) + (0.2*x2_3) + (0.02*uattacked1_3) )
s.add(x2_4 ==  (0.0*x1_3) + (1.0*x2_3) + (0.2*uattacked1_3) )
s.add(xabs1_4 == If(x1_4<0,(-1)*x1_4,x1_4))
s.add(xabs2_4 == If(x2_4<0,(-1)*x2_4,x2_4))
s.add(u1_4 ==  - (22.8788*z1_4) - (6.7644*z2_4))
...
s.add(x1_5 ==  (1.0*x1_4) + (0.2*x2_4) + (0.02*uattacked1_4) )
s.add(x2_5 ==  (0.0*x1_4) + (1.0*x2_4) + (0.2*uattacked1_4) )
...
s.add(x1_6 ==  (1.0*x1_5) + (0.2*x2_5) + (0.02*uattacked1_5) )
s.add(x2_6 ==  (0.0*x1_5) + (1.0*x2_5) + (0.2*uattacked1_5) )
s.add(xabs1_6 == If(x1_6<0,(-1)*x1_6,x1_6))
s.add(xabs2_6 == If(x2_6<0,(-1)*x2_6,x2_6))
s.add(u1_6 ==  - (22.8788*z1_6) - (6.7644*z2_6))
...
s.add(x1_7 ==  (1.0*x1_6) + (0.2*x2_6) + (0.02*uattacked1_6) )
s.add(x2_7 ==  (0.0*x1_6) + (1.0*x2_6) + (0.2*uattacked1_6) )
...
s.add(x1_8 ==  (1.0*x1_7) + (0.2*x2_7) + (0.02*uattacked1_7) )
s.add(x2_8 ==  (0.0*x1_7) + (1.0*x2_7) + (0.2*uattacked1_7) )
s.add(xabs1_8 == If(x1_8<0,(-1)*x1_8,x1_8))
s.add(xabs2_8 == If(x2_8<0,(-1)*x2_8,x2_8))
s.add(u1_8 ==  - (22.8788*z1_8) - (6.7644*z2_8))
...
s.add(x1_9 ==  (1.0*x1_8) + (0.2*x2_8) + (0.02*uattacked1_8) )
s.add(x2_9 ==  (0.0*x1_8) + (1.0*x2_8) + (0.2*uattacked1_8) )
...
s.add(Or((xabs1_0 - 1)>0.1,(xabs1_1 - 1)>0.1,(xabs1_2 - 1)>0.1,(xabs1_3 - 1)>0.1,(xabs1_4 - 1)>0.1,(xabs1_5 - 1)>0.1,(xabs1_6 - 1)>0.1,(xabs1_7 - 1)>0.1,(xabs1_8 - 1)>0.1,(xabs2_0 - 10)>0.1,(xabs2_1 - 10)>0.1,(xabs2_2 - 10)>0.1,(xabs2_3 - 10)>0.1,(xabs2_4 - 10)>0.1,(xabs2_5 - 10)>0.1,(xabs2_6 - 10)>0.1,(xabs2_7 - 10)>0.1,(xabs2_8 - 10)>0.1))
