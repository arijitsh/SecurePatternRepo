...
s.add(x1_10 ==  (1.0*x1_9) + (0.2*x2_9) + (0.02*uattacked1_9) )
s.add(x2_10 ==  (0.0*x1_9) + (1.0*x2_9) + (0.2*uattacked1_9) )
...
s.add(x1_11 ==  (1.0*x1_10) + (0.2*x2_10) + (0.02*uattacked1_10) )
s.add(x2_11 ==  (0.0*x1_10) + (1.0*x2_10) + (0.2*uattacked1_10) )
...
s.add(x1_12 ==  (1.0*x1_11) + (0.2*x2_11) + (0.02*uattacked1_11) )
s.add(x2_12 ==  (0.0*x1_11) + (1.0*x2_11) + (0.2*uattacked1_11) )
...
s.add(x1_13 ==  (1.0*x1_12) + (0.2*x2_12) + (0.02*uattacked1_12) )
s.add(x2_13 ==  (0.0*x1_12) + (1.0*x2_12) + (0.2*uattacked1_12) )
...
s.add(x1_14 ==  (1.0*x1_13) + (0.2*x2_13) + (0.02*uattacked1_13) )
s.add(x2_14 ==  (0.0*x1_13) + (1.0*x2_13) + (0.2*uattacked1_13) )
s.add(xabs1_14 == If(x1_14<0,(-1)*x1_14,x1_14))
s.add(xabs2_14 == If(x2_14<0,(-1)*x2_14,x2_14))
s.add(u1_14 == u1_13)
s.add(uattacked1_14 == uattacked1_13)
s.add(y1_14 ==  + (1*x1_14) + (0*x2_14) + (0*uattacked1_14))
s.add(Or((xabs1_0 - 1)>0.1,(xabs1_1 - 1)>0.1,(xabs1_2 - 1)>0.1,(xabs1_3 - 1)>0.1,(xabs1_4 - 1)>0.1,(xabs1_5 - 1)>0.1,(xabs1_6 - 1)>0.1,(xabs1_7 - 1)>0.1,(xabs1_8 - 1)>0.1,(xabs1_9 - 1)>0.1,(xabs1_10 - 1)>0.1,(xabs1_11 - 1)>0.1,(xabs1_12 - 1)>0.1,(xabs1_13 - 1)>0.1,(xabs2_0 - 10)>0.1,(xabs2_1 - 10)>0.1,(xabs2_2 - 10)>0.1,(xabs2_3 - 10)>0.1,(xabs2_4 - 10)>0.1,(xabs2_5 - 10)>0.1,(xabs2_6 - 10)>0.1,(xabs2_7 - 10)>0.1,(xabs2_8 - 10)>0.1,(xabs2_9 - 10)>0.1,(xabs2_10 - 10)>0.1,(xabs2_11 - 10)>0.1,(xabs2_12 - 10)>0.1,(xabs2_13 - 10)>0.1))
