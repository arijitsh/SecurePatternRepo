...
xabs1 = np.zeros(12, dtype=float)
x1 = np.zeros(12, dtype=float)
z1 = np.zeros(12, dtype=float)
xabs2 = np.zeros(12, dtype=float)
x2 = np.zeros(12, dtype=float)
z2 = np.zeros(12, dtype=float)
y1 = np.zeros(12, dtype=float)
attackOnY1 = np.zeros(12, dtype=float)
r1 = np.zeros(12, dtype=float)
u1 = np.zeros(12, dtype=float)
uattacked1 = np.zeros(12, dtype=float)
attackOnU1 = np.zeros(12, dtype=float)
...
# pattern = 1
s.add(u1_10 ==  - (-0.37124084263270574*z1_9) - (-0.0007441187601164688*z2_9))
...
s.add(Or((xabs1_0 - 30)>1,(xabs1_1 - 30)>1,(xabs1_2 - 30)>1,(xabs1_3 - 30)>1,(xabs1_4 - 30)>1,(xabs1_5 - 30)>1,(xabs1_6 - 30)>1,(xabs1_7 - 30)>1,(xabs1_8 - 30)>1,(xabs1_9 - 30)>1,(xabs1_10 - 30)>1,(xabs2_0 - 30)>1,(xabs2_1 - 30)>1,(xabs2_2 - 30)>1,(xabs2_3 - 30)>1,(xabs2_4 - 30)>1,(xabs2_5 - 30)>1,(xabs2_6 - 30)>1,(xabs2_7 - 30)>1,(xabs2_8 - 30)>1,(xabs2_9 - 30)>1,(xabs2_10 - 30)>1))
