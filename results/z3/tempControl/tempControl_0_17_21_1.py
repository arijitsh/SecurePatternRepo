...
xabs1 = np.zeros(22, dtype=float)
x1 = np.zeros(22, dtype=float)
z1 = np.zeros(22, dtype=float)
xabs2 = np.zeros(22, dtype=float)
x2 = np.zeros(22, dtype=float)
z2 = np.zeros(22, dtype=float)
y1 = np.zeros(22, dtype=float)
attackOnY1 = np.zeros(22, dtype=float)
r1 = np.zeros(22, dtype=float)
u1 = np.zeros(22, dtype=float)
uattacked1 = np.zeros(22, dtype=float)
attackOnU1 = np.zeros(22, dtype=float)
r = np.zeros(22, dtype=float)
...
s.add(r_20 ==rabs1_20 )
s.add(r_20<0.08)
s.add(Or(xabs1_0>0.1,xabs1_1>0.1,xabs1_2>0.1,xabs1_3>0.1,xabs1_4>0.1,xabs1_5>0.1,xabs1_6>0.1,xabs1_7>0.1,xabs1_8>0.1,xabs1_9>0.1,xabs1_10>0.1,xabs1_11>0.1,xabs1_12>0.1,xabs1_13>0.1,xabs1_14>0.1,xabs1_15>0.1,xabs1_16>0.1,xabs1_17>0.1,xabs1_18>0.1,xabs1_19>0.1,xabs1_20>0.1,xabs2_0>0.1,xabs2_1>0.1,xabs2_2>0.1,xabs2_3>0.1,xabs2_4>0.1,xabs2_5>0.1,xabs2_6>0.1,xabs2_7>0.1,xabs2_8>0.1,xabs2_9>0.1,xabs2_10>0.1,xabs2_11>0.1,xabs2_12>0.1,xabs2_13>0.1,xabs2_14>0.1,xabs2_15>0.1,xabs2_16>0.1,xabs2_17>0.1,xabs2_18>0.1,xabs2_19>0.1,xabs2_20>0.1))
