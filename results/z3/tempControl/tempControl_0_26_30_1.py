...
xabs1 = np.zeros(31, dtype=float)
x1 = np.zeros(31, dtype=float)
z1 = np.zeros(31, dtype=float)
xabs2 = np.zeros(31, dtype=float)
x2 = np.zeros(31, dtype=float)
z2 = np.zeros(31, dtype=float)
y1 = np.zeros(31, dtype=float)
attackOnY1 = np.zeros(31, dtype=float)
r1 = np.zeros(31, dtype=float)
u1 = np.zeros(31, dtype=float)
uattacked1 = np.zeros(31, dtype=float)
attackOnU1 = np.zeros(31, dtype=float)
r = np.zeros(31, dtype=float)
...
s.add(r_24<0.08)
# pattern = 1
s.add(z1_25 ==  (0.9464851479534838*z1_24) + (0.0018971440127071484*z2_24) + (-0.04675272148412571*u1_24) + (0.607117400019285*r1_24) )
s.add(z2_25 ==  (0.0*z1_24) + (1.3887943864964021e-11*z2_24) + (-0.9999999999861122*u1_24) + (0.3928825999827503*r1_24) )
s.add(x1_25 ==  (0.9464851479534838*x1_24) + (0.0018971440127071484*x2_24) + (-0.04675272148412571*uattacked1_24) )
s.add(x2_25 ==  (0.0*x1_24) + (1.3887943864964021e-11*x2_24) + (-0.9999999999861122*uattacked1_24) )
s.add(xabs1_25 == If(x1_25<0,(-1)*x1_25,x1_25))
s.add(xabs2_25 == If(x2_25<0,(-1)*x2_25,x2_25))
s.add(u1_25 ==  - (-0.37124084263270574*z1_25) - (-0.0007441187601164688*z2_25))
s.add(uattacked1_25 == u1_25)
s.add(y1_25 ==  + (1*x1_25) + (0*x2_25) + (0*u1_25))
s.add(r1_25 == y1_25 - (1*z1_25) - (0*z2_25) - (0*uattacked1_25))
s.add(rabs1_25 == If(r1_25<0,(-1)*r1_25,r1_25))
s.add(r_25 ==rabs1_25 )
s.add(r_25<0.08)
# pattern = 1
s.add(z1_26 ==  (0.9464851479534838*z1_25) + (0.0018971440127071484*z2_25) + (-0.04675272148412571*u1_25) + (0.607117400019285*r1_25) )
s.add(z2_26 ==  (0.0*z1_25) + (1.3887943864964021e-11*z2_25) + (-0.9999999999861122*u1_25) + (0.3928825999827503*r1_25) )
s.add(x1_26 ==  (0.9464851479534838*x1_25) + (0.0018971440127071484*x2_25) + (-0.04675272148412571*uattacked1_25) )
s.add(x2_26 ==  (0.0*x1_25) + (1.3887943864964021e-11*x2_25) + (-0.9999999999861122*uattacked1_25) )
s.add(xabs1_26 == If(x1_26<0,(-1)*x1_26,x1_26))
s.add(xabs2_26 == If(x2_26<0,(-1)*x2_26,x2_26))
s.add(u1_26 ==  - (-0.37124084263270574*z1_26) - (-0.0007441187601164688*z2_26))
s.add(uattacked1_26 == u1_26)
s.add(y1_26 ==  + (1*x1_26) + (0*x2_26) + (0*u1_26))
s.add(r1_26 == y1_26 - (1*z1_26) - (0*z2_26) - (0*uattacked1_26))
s.add(rabs1_26 == If(r1_26<0,(-1)*r1_26,r1_26))
s.add(r_26 ==rabs1_26 )
s.add(r_26<0.08)
# pattern = 1
s.add(z1_27 ==  (0.9464851479534838*z1_26) + (0.0018971440127071484*z2_26) + (-0.04675272148412571*u1_26) + (0.607117400019285*r1_26) )
s.add(z2_27 ==  (0.0*z1_26) + (1.3887943864964021e-11*z2_26) + (-0.9999999999861122*u1_26) + (0.3928825999827503*r1_26) )
s.add(x1_27 ==  (0.9464851479534838*x1_26) + (0.0018971440127071484*x2_26) + (-0.04675272148412571*uattacked1_26) )
s.add(x2_27 ==  (0.0*x1_26) + (1.3887943864964021e-11*x2_26) + (-0.9999999999861122*uattacked1_26) )
s.add(xabs1_27 == If(x1_27<0,(-1)*x1_27,x1_27))
s.add(xabs2_27 == If(x2_27<0,(-1)*x2_27,x2_27))
s.add(u1_27 ==  - (-0.37124084263270574*z1_27) - (-0.0007441187601164688*z2_27))
s.add(uattacked1_27 == u1_27)
s.add(y1_27 ==  + (1*x1_27) + (0*x2_27) + (0*u1_27))
s.add(r1_27 == y1_27 - (1*z1_27) - (0*z2_27) - (0*uattacked1_27))
s.add(rabs1_27 == If(r1_27<0,(-1)*r1_27,r1_27))
s.add(r_27 ==rabs1_27 )
s.add(r_27<0.08)
# pattern = 1
s.add(z1_28 ==  (0.9464851479534838*z1_27) + (0.0018971440127071484*z2_27) + (-0.04675272148412571*u1_27) + (0.607117400019285*r1_27) )
s.add(z2_28 ==  (0.0*z1_27) + (1.3887943864964021e-11*z2_27) + (-0.9999999999861122*u1_27) + (0.3928825999827503*r1_27) )
s.add(x1_28 ==  (0.9464851479534838*x1_27) + (0.0018971440127071484*x2_27) + (-0.04675272148412571*uattacked1_27) )
s.add(x2_28 ==  (0.0*x1_27) + (1.3887943864964021e-11*x2_27) + (-0.9999999999861122*uattacked1_27) )
s.add(xabs1_28 == If(x1_28<0,(-1)*x1_28,x1_28))
s.add(xabs2_28 == If(x2_28<0,(-1)*x2_28,x2_28))
s.add(u1_28 ==  - (-0.37124084263270574*z1_28) - (-0.0007441187601164688*z2_28))
s.add(uattacked1_28 == u1_28)
s.add(y1_28 ==  + (1*x1_28) + (0*x2_28) + (0*u1_28))
s.add(r1_28 == y1_28 - (1*z1_28) - (0*z2_28) - (0*uattacked1_28))
s.add(rabs1_28 == If(r1_28<0,(-1)*r1_28,r1_28))
s.add(r_28 ==rabs1_28 )
s.add(r_28<0.08)
# pattern = 1
s.add(z1_29 ==  (0.9464851479534838*z1_28) + (0.0018971440127071484*z2_28) + (-0.04675272148412571*u1_28) + (0.607117400019285*r1_28) )
s.add(z2_29 ==  (0.0*z1_28) + (1.3887943864964021e-11*z2_28) + (-0.9999999999861122*u1_28) + (0.3928825999827503*r1_28) )
s.add(x1_29 ==  (0.9464851479534838*x1_28) + (0.0018971440127071484*x2_28) + (-0.04675272148412571*uattacked1_28) )
s.add(x2_29 ==  (0.0*x1_28) + (1.3887943864964021e-11*x2_28) + (-0.9999999999861122*uattacked1_28) )
s.add(xabs1_29 == If(x1_29<0,(-1)*x1_29,x1_29))
s.add(xabs2_29 == If(x2_29<0,(-1)*x2_29,x2_29))
s.add(u1_29 ==  - (-0.37124084263270574*z1_29) - (-0.0007441187601164688*z2_29))
s.add(uattacked1_29 == u1_29)
s.add(y1_29 ==  + (1*x1_29) + (0*x2_29) + (0*u1_29))
s.add(r1_29 == y1_29 - (1*z1_29) - (0*z2_29) - (0*uattacked1_29))
s.add(rabs1_29 == If(r1_29<0,(-1)*r1_29,r1_29))
s.add(r_29 ==rabs1_29 )
s.add(r_29<0.08)
s.add(Or(xabs1_0>0.1,xabs1_1>0.1,xabs1_2>0.1,xabs1_3>0.1,xabs1_4>0.1,xabs1_5>0.1,xabs1_6>0.1,xabs1_7>0.1,xabs1_8>0.1,xabs1_9>0.1,xabs1_10>0.1,xabs1_11>0.1,xabs1_12>0.1,xabs1_13>0.1,xabs1_14>0.1,xabs1_15>0.1,xabs1_16>0.1,xabs1_17>0.1,xabs1_18>0.1,xabs1_19>0.1,xabs1_20>0.1,xabs1_21>0.1,xabs1_22>0.1,xabs1_23>0.1,xabs1_24>0.1,xabs1_25>0.1,xabs1_26>0.1,xabs1_27>0.1,xabs1_28>0.1,xabs1_29>0.1,xabs2_0>0.1,xabs2_1>0.1,xabs2_2>0.1,xabs2_3>0.1,xabs2_4>0.1,xabs2_5>0.1,xabs2_6>0.1,xabs2_7>0.1,xabs2_8>0.1,xabs2_9>0.1,xabs2_10>0.1,xabs2_11>0.1,xabs2_12>0.1,xabs2_13>0.1,xabs2_14>0.1,xabs2_15>0.1,xabs2_16>0.1,xabs2_17>0.1,xabs2_18>0.1,xabs2_19>0.1,xabs2_20>0.1,xabs2_21>0.1,xabs2_22>0.1,xabs2_23>0.1,xabs2_24>0.1,xabs2_25>0.1,xabs2_26>0.1,xabs2_27>0.1,xabs2_28>0.1,xabs2_29>0.1))
