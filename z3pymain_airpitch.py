...
while index<K and isSat == 0:
    ...
    f.write("if isSat==1:\n")
    f.write("\tf0 = open(\"airpitchControlResult.txt\", \"w+\")\n")
    f.write("\tf0.write(\"1\")\n")
    f.write("\tf0.close()\n")
    ...
    f.close()
    os.system("python airpitchControl.py>airpitchControl.out")

    f0 = open("airpitchControlResult.txt","r")
    if f0.mode == 'r':
        content = f0.read()
        isSat = int(content)
    f0.close()
