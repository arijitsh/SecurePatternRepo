...
float nondet_float();
int8_t nondet_int8();
int const K =15,attackLen = 10, startpoint = 0;
int main()
	{
		...
		u_attack[0][7] = 0;
		u_attack[1][7] = 0;
		y_attack[0][7] = AttackFormat2(syn);
		y_attack[1][7] = AttackFormat2(syn);
		...
		u_attack[0][8] = 0;
		u_attack[1][8] = 0;
		y_attack[0][8] = AttackFormat2(syn);
		y_attack[1][8] = AttackFormat2(syn);
		...
		u_attack[0][9] = 0;
		u_attack[1][9] = 0;
		y_attack[0][9] = AttackFormat2(syn);
		y_attack[1][9] = AttackFormat2(syn);
