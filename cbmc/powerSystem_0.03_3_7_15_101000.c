...
float nondet_float();
int8_t nondet_int8();
int const K = 15,attackLen = 7, startpoint = 3;
int main()
	{
		...
		//pattern=1;
		syn = nondet_int8();
		a1[7] = AttackFormat2(syn);
		syn = nondet_int8();
		a2[7] = AttackFormat2(syn);
		...
		//pattern=1;
		syn = nondet_int8();
		a1[8] = AttackFormat2(syn);
		syn = nondet_int8();
		a2[8] = AttackFormat2(syn);
		...
		//pattern=1;
		syn = nondet_int8();
		a1[9] = AttackFormat2(syn);
		syn = nondet_int8();
		a2[9] = AttackFormat2(syn);
