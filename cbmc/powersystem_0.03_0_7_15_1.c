...
int main()
	{
		...
		a1[15] = 0;
		a2[15] = 0;
		u_15 = -(0.0556*z1_15) - (0.3306*z2_15);
		u_attacked_15 = u_15 + a1[15];
		y1_15 = x1_15 + a2[15];
		y2_15 = x2_15;
		r1[15] = y1_15 - z1_15;
		r2[15] = y2_15 - z2_15;
		r[15] = max(absolute(r1[15]),absolute(r2[15]));
		z1_16 = (0.66*z1_15) + (0.53*z2_15) + (0.34*u_15) + (0.36*r1[15]) + (0.27*r2[15]);
		z2_16 = -(0.53*z1_15) + (0.13*z2_15) + (0.53*u_15) - (0.31*r1[15]) + (0.08*r2[15]);
		x1_16 = (0.66*x1_15) + (0.53*x2_15) + (0.34*u_attacked_15);
		x2_16 = - (0.53*x1_15) + (0.13*x2_15) + (0.53*u_attacked_15);
		theta[15] = absolute(x1_16);
		omega[15] = absolute(x2_16);


		assert(((r[0]>0.03) || (r[1]>0.03) || (r[2]>0.03) || (r[3]>0.03) || (r[4]>0.03) || (r[5]>0.03) || (r[6]>0.03) || (r[7]>0.03) || (r[8]>0.03) || (r[9]>0.03) || (r[10]>0.03) || (r[11]>0.03) || (r[12]>0.03) || (r[13]>0.03) || (r[14]>0.03))||((theta[0]<=0.1 && omega[0]<=0.05) && (theta[1]<=0.1 && omega[1]<=0.05) && (theta[2]<=0.1 && omega[2]<=0.05) && (theta[3]<=0.1 && omega[3]<=0.05) && (theta[4]<=0.1 && omega[4]<=0.05) && (theta[5]<=0.1 && omega[5]<=0.05) && (theta[6]<=0.1 && omega[6]<=0.05) && (theta[7]<=0.1 && omega[7]<=0.05) && (theta[8]<=0.1 && omega[8]<=0.05) && (theta[9]<=0.1 && omega[9]<=0.05) && (theta[10]<=0.1 && omega[10]<=0.05) && (theta[11]<=0.1 && omega[11]<=0.05) && (theta[12]<=0.1 && omega[12]<=0.05) && (theta[13]<=0.1 && omega[13]<=0.05) && (theta[14]<=0.1 && omega[14]<=0.05)));
		return 0;
	}