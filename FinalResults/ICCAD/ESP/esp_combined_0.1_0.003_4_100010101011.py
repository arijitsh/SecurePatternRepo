...
xabs1 = np.zeros(17, dtype=float)
x1 = np.zeros(17, dtype=float)
z1 = np.zeros(17, dtype=float)
xabs2 = np.zeros(17, dtype=float)
x2 = np.zeros(17, dtype=float)
z2 = np.zeros(17, dtype=float)
y1 = np.zeros(17, dtype=float)
attackOnY1 = np.zeros(17, dtype=float)
r1 = np.zeros(17, dtype=float)
u1 = np.zeros(17, dtype=float)
uattacked1 = np.zeros(17, dtype=float)
attackOnU1 = np.zeros(17, dtype=float)
r = np.zeros(17, dtype=float)
...
s.add(y1_10 == (1.0*attackOnY1_9) + (0*x1_10) + (1*x2_10) + (0*uattacked1_10))
...
s.add(u1_11 ==  - (-0.0987*z1_11) - (0.142*z2_11))
attackOnU1_10 = Real('attackOnU1_10')
s.add(uattacked1_11 == u1_11+ (1.0*attackOnU1_10))
s.add(And(u1_11>-13,u1_11<13))
s.add(And(uattacked1_11>-13,uattacked1_11<13))
attackOnY1_10 = Real('attackOnY1_10')
s.add(y1_11 == (1.0*attackOnY1_10) + (0*x1_11) + (1*x2_11) + (0*uattacked1_11))
s.add(And(y1_11>-2.5,y1_11<2.5))
# pattern = 1
...
s.add(u1_12 ==  - (-0.0987*z1_12) - (0.142*z2_12))
attackOnU1_11 = Real('attackOnU1_11')
s.add(uattacked1_12 == u1_12+ (1.0*attackOnU1_11))
s.add(And(u1_12>-13,u1_12<13))
s.add(And(uattacked1_12>-13,uattacked1_12<13))
attackOnY1_11 = Real('attackOnY1_11')
s.add(y1_12 == (1.0*attackOnY1_11) + (0*x1_12) + (1*x2_12) + (0*uattacked1_12))
s.add(And(y1_12>-2.5,y1_12<2.5))
# pattern = 1
...
s.add(And(u1_13>-13,u1_13<13))
s.add(And(uattacked1_13>-13,uattacked1_13<13))
s.add(y1_13 ==  + (0*x1_13) + (1*x2_13) + (0*uattacked1_13))
s.add(And(y1_13>-2.5,y1_13<2.5))
# pattern = 0
s.add(r1_13 == y1_13 - (0*z1_13) - (1*z2_13) - (0*u1_13))
s.add(rabs1_13 == If(r1_13<0,(-1)*r1_13,r1_13))
s.add(r_13 ==rabs1_13 )
s.add(r_13<0.003)
s.add(z1_14 ==  (0.445*z1_13) + (-0.0458*z2_13) + (0.055*u1_13) + (-0.039*r1_13) )
s.add(z2_14 ==  (1.2939*z1_13) + (0.4402*z2_13) + (4.5607*u1_13) + (0.4339*r1_13) )
s.add(x1_14 ==  (0.445*x1_13) + (-0.0458*x2_13) + (0.055*uattacked1_13) )
s.add(x2_14 ==  (1.2939*x1_13) + (0.4402*x2_13) + (4.5607*uattacked1_13) )
s.add(xabs1_14 == If(x1_14<0,(-1)*x1_14,x1_14))
s.add(xabs2_14 == If(x2_14<0,(-1)*x2_14,x2_14))
s.add(u1_14 == u1_13)
s.add(uattacked1_14 == uattacked1_13)
s.add(And(u1_14>-13,u1_14<13))
s.add(And(uattacked1_14>-13,uattacked1_14<13))
s.add(y1_14 ==  + (0*x1_14) + (1*x2_14) + (0*uattacked1_14))
s.add(And(y1_14>-2.5,y1_14<2.5))
# pattern = 0
s.add(r1_14 == y1_14 - (0*z1_14) - (1*z2_14) - (0*u1_14))
s.add(rabs1_14 == If(r1_14<0,(-1)*r1_14,r1_14))
s.add(r_14 ==rabs1_14 )
s.add(r_14<0.003)
s.add(z1_15 ==  (0.445*z1_14) + (-0.0458*z2_14) + (0.055*u1_14) + (-0.039*r1_14) )
s.add(z2_15 ==  (1.2939*z1_14) + (0.4402*z2_14) + (4.5607*u1_14) + (0.4339*r1_14) )
s.add(x1_15 ==  (0.445*x1_14) + (-0.0458*x2_14) + (0.055*uattacked1_14) )
s.add(x2_15 ==  (1.2939*x1_14) + (0.4402*x2_14) + (4.5607*uattacked1_14) )
s.add(xabs1_15 == If(x1_15<0,(-1)*x1_15,x1_15))
s.add(xabs2_15 == If(x2_15<0,(-1)*x2_15,x2_15))
s.add(u1_15 == u1_14)
s.add(uattacked1_15 == uattacked1_14)
s.add(And(u1_15>-13,u1_15<13))
s.add(And(uattacked1_15>-13,uattacked1_15<13))
s.add(y1_15 ==  + (0*x1_15) + (1*x2_15) + (0*uattacked1_15))
s.add(And(y1_15>-2.5,y1_15<2.5))
# pattern = 0
s.add(r1_15 == y1_15 - (0*z1_15) - (1*z2_15) - (0*u1_15))
s.add(rabs1_15 == If(r1_15<0,(-1)*r1_15,r1_15))
s.add(r_15 ==rabs1_15 )
s.add(r_15<0.003)
s.add(z1_16 ==  (0.445*z1_15) + (-0.0458*z2_15) + (0.055*u1_15) + (-0.039*r1_15) )
s.add(z2_16 ==  (1.2939*z1_15) + (0.4402*z2_15) + (4.5607*u1_15) + (0.4339*r1_15) )
s.add(x1_16 ==  (0.445*x1_15) + (-0.0458*x2_15) + (0.055*uattacked1_15) )
s.add(x2_16 ==  (1.2939*x1_15) + (0.4402*x2_15) + (4.5607*uattacked1_15) )
s.add(xabs1_16 == If(x1_16<0,(-1)*x1_16,x1_16))
s.add(xabs2_16 == If(x2_16<0,(-1)*x2_16,x2_16))
s.add(u1_16 == u1_15)
s.add(uattacked1_16 == uattacked1_15)
s.add(And(u1_16>-13,u1_16<13))
s.add(And(uattacked1_16>-13,uattacked1_16<13))
s.add(y1_16 ==  + (0*x1_16) + (1*x2_16) + (0*uattacked1_16))
s.add(And(y1_16>-2.5,y1_16<2.5))
s.add(Or((xabs1_0 - 1)>0.1,(xabs1_1 - 1)>0.1,(xabs1_2 - 1)>0.1,(xabs1_3 - 1)>0.1,(xabs1_4 - 1)>0.1,(xabs1_5 - 1)>0.1,(xabs1_6 - 1)>0.1,(xabs1_7 - 1)>0.1,(xabs1_8 - 1)>0.1,(xabs1_9 - 1)>0.1,(xabs1_10 - 1)>0.1,(xabs1_11 - 1)>0.1,(xabs1_12 - 1)>0.1,(xabs1_13 - 1)>0.1,(xabs1_14 - 1)>0.1,(xabs1_15 - 1)>0.1,(xabs2_0 - 2)>0.1,(xabs2_1 - 2)>0.1,(xabs2_2 - 2)>0.1,(xabs2_3 - 2)>0.1,(xabs2_4 - 2)>0.1,(xabs2_5 - 2)>0.1,(xabs2_6 - 2)>0.1,(xabs2_7 - 2)>0.1,(xabs2_8 - 2)>0.1,(xabs2_9 - 2)>0.1,(xabs2_10 - 2)>0.1,(xabs2_11 - 2)>0.1,(xabs2_12 - 2)>0.1,(xabs2_13 - 2)>0.1,(xabs2_14 - 2)>0.1,(xabs2_15 - 2)>0.1))
