...
xabs1 = np.zeros(16, dtype=float)
x1 = np.zeros(16, dtype=float)
z1 = np.zeros(16, dtype=float)
xabs2 = np.zeros(16, dtype=float)
...
uattacked1 = np.zeros(16, dtype=float)
...
s.add(u1_15 ==  - (-0.0987*z1_15) - (0.142*z2_15))
...
s.add(Or((xabs1_0 - 1)>0.1,(xabs1_1 - 1)>0.1,(xabs1_2 - 1)>0.1,(xabs1_3 - 1)>0.1,(xabs1_4 - 1)>0.1,(xabs1_5 - 1)>0.1,(xabs1_6 - 1)>0.1,(xabs1_7 - 1)>0.1,(xabs1_8 - 1)>0.1,(xabs1_9 - 1)>0.1,(xabs1_10 - 1)>0.1,(xabs1_11 - 1)>0.1,(xabs1_12 - 1)>0.1,(xabs1_13 - 1)>0.1,(xabs1_14 - 1)>0.1,(xabs2_0 - 2)>0.1,(xabs2_1 - 2)>0.1,(xabs2_2 - 2)>0.1,(xabs2_3 - 2)>0.1,(xabs2_4 - 2)>0.1,(xabs2_5 - 2)>0.1,(xabs2_6 - 2)>0.1,(xabs2_7 - 2)>0.1,(xabs2_8 - 2)>0.1,(xabs2_9 - 2)>0.1,(xabs2_10 - 2)>0.1,(xabs2_11 - 2)>0.1,(xabs2_12 - 2)>0.1,(xabs2_13 - 2)>0.1,(xabs2_14 - 2)>0.1))
