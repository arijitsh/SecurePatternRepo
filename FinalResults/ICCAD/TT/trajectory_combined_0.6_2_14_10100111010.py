...
xabs1 = np.zeros(23, dtype=float)
x1 = np.zeros(23, dtype=float)
z1 = np.zeros(23, dtype=float)
xabs2 = np.zeros(23, dtype=float)
x2 = np.zeros(23, dtype=float)
z2 = np.zeros(23, dtype=float)
y1 = np.zeros(23, dtype=float)
attackOnY1 = np.zeros(23, dtype=float)
r1 = np.zeros(23, dtype=float)
u1 = np.zeros(23, dtype=float)
uattacked1 = np.zeros(23, dtype=float)
attackOnU1 = np.zeros(23, dtype=float)
r = np.zeros(23, dtype=float)
...
s.add(r_18 ==rabs1_18 )
s.add(r_18<2)
s.add(z1_19 ==  (1.0*z1_18) + (0.1*z2_18) + (0.005*u1_18) + (0.9902*r1_18) )
s.add(z2_19 ==  (0.0*z1_18) + (1.0*z2_18) + (0.1*u1_18) + (0.9892*r1_18) )
...
s.add(And(u1_19>-36,u1_19<36))
s.add(And(uattacked1_19>-36,uattacked1_19<36))
s.add(y1_19 ==  + (1*x1_19) + (0*x2_19) + (0*uattacked1_19))
s.add(And(y1_19>-3000000,y1_19<3000000))
# pattern = 0
s.add(r1_19 == y1_19 - (1*z1_19) - (0*z2_19) - (0*u1_19))
s.add(rabs1_19 == If(r1_19<0,(-1)*r1_19,r1_19))
s.add(r_19 ==rabs1_19 )
s.add(r_19<2)
s.add(z1_20 ==  (1.0*z1_19) + (0.1*z2_19) + (0.005*u1_19) + (0.9902*r1_19) )
s.add(z2_20 ==  (0.0*z1_19) + (1.0*z2_19) + (0.1*u1_19) + (0.9892*r1_19) )
...
s.add(u1_20 == u1_19)
s.add(uattacked1_20 == uattacked1_19)
s.add(And(u1_20>-36,u1_20<36))
s.add(And(uattacked1_20>-36,uattacked1_20<36))
s.add(y1_20 ==  + (1*x1_20) + (0*x2_20) + (0*uattacked1_20))
s.add(And(y1_20>-3000000,y1_20<3000000))
# pattern = 1
s.add(r1_20 == y1_20 - (1*z1_20) - (0*z2_20) - (0*u1_20))
s.add(rabs1_20 == If(r1_20<0,(-1)*r1_20,r1_20))
s.add(r_20 ==rabs1_20 )
s.add(r_20<2)
s.add(z1_21 ==  (1.0*z1_20) + (0.1*z2_20) + (0.005*u1_20) + (0.9902*r1_20) )
s.add(z2_21 ==  (0.0*z1_20) + (1.0*z2_20) + (0.1*u1_20) + (0.9892*r1_20) )
...
s.add(And(u1_21>-36,u1_21<36))
s.add(And(uattacked1_21>-36,uattacked1_21<36))
s.add(y1_21 ==  + (1*x1_21) + (0*x2_21) + (0*uattacked1_21))
s.add(And(y1_21>-3000000,y1_21<3000000))
# pattern = 0
s.add(r1_21 == y1_21 - (1*z1_21) - (0*z2_21) - (0*u1_21))
s.add(rabs1_21 == If(r1_21<0,(-1)*r1_21,r1_21))
s.add(r_21 ==rabs1_21 )
s.add(r_21<2)
s.add(z1_22 ==  (1.0*z1_21) + (0.1*z2_21) + (0.005*u1_21) + (0.9902*r1_21) )
s.add(z2_22 ==  (0.0*z1_21) + (1.0*z2_21) + (0.1*u1_21) + (0.9892*r1_21) )
...
s.add(u1_22 == u1_21)
s.add(uattacked1_22 == uattacked1_21)
s.add(And(u1_22>-36,u1_22<36))
s.add(And(uattacked1_22>-36,uattacked1_22<36))
s.add(y1_22 ==  + (1*x1_22) + (0*x2_22) + (0*uattacked1_22))
s.add(And(y1_22>-3000000,y1_22<3000000))
s.add(Or((xabs1_0 - 25)>1,(xabs1_1 - 25)>1,(xabs1_2 - 25)>1,(xabs1_3 - 25)>1,(xabs1_4 - 25)>1,(xabs1_5 - 25)>1,(xabs1_6 - 25)>1,(xabs1_7 - 25)>1,(xabs1_8 - 25)>1,(xabs1_9 - 25)>1,(xabs1_10 - 25)>1,(xabs1_11 - 25)>1,(xabs1_12 - 25)>1,(xabs1_13 - 25)>1,(xabs1_14 - 25)>1,(xabs1_15 - 25)>1,(xabs1_16 - 25)>1,(xabs1_17 - 25)>1,(xabs1_18 - 25)>1,(xabs1_19 - 25)>1,(xabs1_20 - 25)>1,(xabs1_21 - 25)>1,(xabs2_0 - 30)>1,(xabs2_1 - 30)>1,(xabs2_2 - 30)>1,(xabs2_3 - 30)>1,(xabs2_4 - 30)>1,(xabs2_5 - 30)>1,(xabs2_6 - 30)>1,(xabs2_7 - 30)>1,(xabs2_8 - 30)>1,(xabs2_9 - 30)>1,(xabs2_10 - 30)>1,(xabs2_11 - 30)>1,(xabs2_12 - 30)>1,(xabs2_13 - 30)>1,(xabs2_14 - 30)>1,(xabs2_15 - 30)>1,(xabs2_16 - 30)>1,(xabs2_17 - 30)>1,(xabs2_18 - 30)>1,(xabs2_19 - 30)>1,(xabs2_20 - 30)>1,(xabs2_21 - 30)>1))
