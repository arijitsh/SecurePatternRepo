...
xabs1 = np.zeros(20, dtype=float)
x1 = np.zeros(20, dtype=float)
z1 = np.zeros(20, dtype=float)
xabs2 = np.zeros(20, dtype=float)
x2 = np.zeros(20, dtype=float)
z2 = np.zeros(20, dtype=float)
y1 = np.zeros(20, dtype=float)
attackOnY1 = np.zeros(20, dtype=float)
r1 = np.zeros(20, dtype=float)
u1 = np.zeros(20, dtype=float)
uattacked1 = np.zeros(20, dtype=float)
attackOnU1 = np.zeros(20, dtype=float)
...
s.add(y1_5 == (1.0*attackOnY1_4) + (1*x1_5) + (0*x2_5) + (0*u1_5))
...
s.add(y1_6 == (1.0*attackOnY1_5) + (1*x1_6) + (0*x2_6) + (0*u1_6))
...
s.add(y1_7 == (1.0*attackOnY1_6) + (1*x1_7) + (0*x2_7) + (0*u1_7))
...
s.add(y1_8 == (1.0*attackOnY1_7) + (1*x1_8) + (0*x2_8) + (0*u1_8))
...
s.add(y1_9 == (1.0*attackOnY1_8) + (1*x1_9) + (0*x2_9) + (0*u1_9))
...
s.add(y1_10 == (1.0*attackOnY1_9) + (1*x1_10) + (0*x2_10) + (0*u1_10))
...
s.add(y1_12 == (1.0*attackOnY1_11) + (1*x1_12) + (0*x2_12) + (0*u1_12))
...
s.add(y1_13 == (1.0*attackOnY1_12) + (1*x1_13) + (0*x2_13) + (0*u1_13))
...
s.add(y1_14 == (1.0*attackOnY1_13) + (1*x1_14) + (0*x2_14) + (0*u1_14))
...
s.add(y1_15 == (1.0*attackOnY1_14) + (1*x1_15) + (0*x2_15) + (0*u1_15))
...
s.add(u1_19 == u1_18)
s.add(uattacked1_19 == uattacked1_18)
s.add(y1_19 == 0)
s.add(And(u1_19>-36,u1_19<36))
s.add(And(uattacked1_19>-36,uattacked1_19<36))
s.add(And(y1_19>-3000000,y1_19<3000000))
s.add(Or((xabs1_0 - 25)>1,(xabs1_1 - 25)>1,(xabs1_2 - 25)>1,(xabs1_3 - 25)>1,(xabs1_4 - 25)>1,(xabs1_5 - 25)>1,(xabs1_6 - 25)>1,(xabs1_7 - 25)>1,(xabs1_8 - 25)>1,(xabs1_9 - 25)>1,(xabs1_10 - 25)>1,(xabs1_11 - 25)>1,(xabs1_12 - 25)>1,(xabs1_13 - 25)>1,(xabs1_14 - 25)>1,(xabs1_15 - 25)>1,(xabs1_16 - 25)>1,(xabs1_17 - 25)>1,(xabs1_18 - 25)>1,(xabs2_0 - 30)>1,(xabs2_1 - 30)>1,(xabs2_2 - 30)>1,(xabs2_3 - 30)>1,(xabs2_4 - 30)>1,(xabs2_5 - 30)>1,(xabs2_6 - 30)>1,(xabs2_7 - 30)>1,(xabs2_8 - 30)>1,(xabs2_9 - 30)>1,(xabs2_10 - 30)>1,(xabs2_11 - 30)>1,(xabs2_12 - 30)>1,(xabs2_13 - 30)>1,(xabs2_14 - 30)>1,(xabs2_15 - 30)>1,(xabs2_16 - 30)>1,(xabs2_17 - 30)>1,(xabs2_18 - 30)>1))
