...
xabs1 = np.zeros(21, dtype=float)
x1 = np.zeros(21, dtype=float)
z1 = np.zeros(21, dtype=float)
xabs2 = np.zeros(21, dtype=float)
x2 = np.zeros(21, dtype=float)
z2 = np.zeros(21, dtype=float)
y1 = np.zeros(21, dtype=float)
attackOnY1 = np.zeros(21, dtype=float)
r1 = np.zeros(21, dtype=float)
u1 = np.zeros(21, dtype=float)
uattacked1 = np.zeros(21, dtype=float)
attackOnU1 = np.zeros(21, dtype=float)
r = np.zeros(21, dtype=float)
...
s.add(Or((xabs1_0 - 25)>1,(xabs1_1 - 25)>1,(xabs1_2 - 25)>1,(xabs1_3 - 25)>1,(xabs1_4 - 25)>1,(xabs1_5 - 25)>1,(xabs1_6 - 25)>1,(xabs1_7 - 25)>1,(xabs1_8 - 25)>1,(xabs1_9 - 25)>1,(xabs1_10 - 25)>1,(xabs1_11 - 25)>1,(xabs1_12 - 25)>1,(xabs1_13 - 25)>1,(xabs1_14 - 25)>1,(xabs1_15 - 25)>1,(xabs1_16 - 25)>1,(xabs1_17 - 25)>1,(xabs1_18 - 25)>1,(xabs1_19 - 25)>1,(xabs2_0 - 30)>1,(xabs2_1 - 30)>1,(xabs2_2 - 30)>1,(xabs2_3 - 30)>1,(xabs2_4 - 30)>1,(xabs2_5 - 30)>1,(xabs2_6 - 30)>1,(xabs2_7 - 30)>1,(xabs2_8 - 30)>1,(xabs2_9 - 30)>1,(xabs2_10 - 30)>1,(xabs2_11 - 30)>1,(xabs2_12 - 30)>1,(xabs2_13 - 30)>1,(xabs2_14 - 30)>1,(xabs2_15 - 30)>1,(xabs2_16 - 30)>1,(xabs2_17 - 30)>1,(xabs2_18 - 30)>1,(xabs2_19 - 30)>1))
